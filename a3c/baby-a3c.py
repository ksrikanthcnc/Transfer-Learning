...
vid = VideoWriter('demo_breakout.avi', VideoWriter_fourcc(*"XVID"), float(30), (160,210), False)

os.environ['OMP_NUM_THREADS'] = '2'	#number of threads for asyncronous
